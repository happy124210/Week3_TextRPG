...
namespace TextRPG_Team25
{
    internal class Battle(Monster monster)
    {
        ...
        public void MonsterAttack()
        {
            ...
            for (int battleMonster = 0; battleMonster <= MonsterList.Count; battleMonster++)  //랜덤으로 생성된 적 개체수만큼 실행
            {
            ...
            if (BattleHP <= 0) { battleMonster = MonsterList.Count + 1; } //플레이어의 전투HP가 0이되면 for문에서 
            }
        }
